...
const uploadImages = async (file: File) => {
  ...
  // Tạo một tác vụ tải lên (upload task) cho tệp tin
...
export default function AddCategory() {
  ...
  const {
    register, // theo dõi các giá trị nhập liệu và trạng thái của các trường 
    formState: { errors }, // thông tin về trạng thái
    handleSubmit,
  } = useForm<Inputs>({
    criteriaMode: "all", // kiểm tra tất cả các loại điều kiện hợp lệ
  });
