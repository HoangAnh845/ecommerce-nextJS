        ...
        <div className="w-4/5 grid grid-cols-4 gap-4">
          ...
          <div>
            ...
            <ul className="mt-4 leading-6 text-xs">
              ...
              <li className="cursor-pointer hover:text-orange-500">Returns</li>
              <li className="cursor-pointer hover:text-orange-500">Shipping</li>
              <li className="cursor-pointer hover:text-orange-500">Wishlist</li>
              <li className="cursor-pointer hover:text-orange-500">
                How Does It Work
              </li>
              <li className="cursor-pointer hover:text-orange-500">
