      ...
      <DataTable
        ...
        subHeaderComponent={
          <div className="flex items-center">
            ...
            />
            <div
              className="ms-4 border px-3 py-2 rounded-lg shadow-md hover:bg-orange-500 hover:text-white cursor-pointer"
              onClick={() => {
                return dispatch(setNavActive("activeCategoriesAdd"));
              }}
            >
              Add item
            </div>
